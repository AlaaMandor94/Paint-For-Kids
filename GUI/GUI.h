...
public:
	...
	void ClearColorArea() const;	//Clears the color area
	
	// -- Figures Drawing functions
	void DrawSquare(Point P1, int length, GfxInfo RectGfxInfo, bool selected=false) const;  //Draw a Square
	void DrawEllipse(Point P1, Point P2, GfxInfo ElpsGfxInfo, bool selected) const;  //Draw an ellipse
	void DrawCircle(Point P1, Point P2, GfxInfo ElpsGfxInfo, bool selected) const;
	void DrawHexagon(Point P1, Point P2, GfxInfo ElpsGfxInfo, bool selected) const;
